...
public class DefaultUserService implements UserService {
	...
	public void listAdmin(String structureId, String classId, String groupId,
		...
		String query =
				...
				"collect(distinct [f.externalId, rf.scope]) as functions, " +
				"CASE WHEN parent IS NULL THEN [] ELSE collect(distinct {id: parent.id, externalId: parent.externalId, firstName: parent.firstName, lastName: parent.lastName}) END as parents, " +
